      ...
      >
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-black tracking-tight text-on-surface">Identity Verified</h1>
        ...
        {/* Student Record Card */}
        <Card className="p-8 space-y-6 border-2 border-green-200 bg-white">
          {/* Student Photo and Name */}
          <div className="flex gap-6">
            <div className="w-32 h-32 rounded-lg overflow-hidden border-2 border-outline-variant/30 shrink-0 shadow-md">
              <img
            ...
            <div className="flex-1 space-y-4 my-auto">
              <div>
                ...
                <h2 className="text-3xl font-black text-on-surface">{student.name}</h2>
              </div>
              <div>
                <p className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.2em] mb-1">
                  HTU Index Number
          ...
          <div className="pt-6 border-t border-outline-variant/30 grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-semibold text-on-surface">{student.status}</p>
            </div>
            <div>
              <p className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.2em] mb-1">
                Email
          ...
          {/* Verification Status */}
          <div className="pt-6 border-t border-outline-variant/30 flex items-center gap-3 p-4 bg-green-50 rounded-lg border border-green-200">
            <ShieldCheck className="w-5 h-5 text-green-600 shrink-0 fill-green-50" />
            <div className="flex-1">
              <p className="text-sm font-bold text-green-900">Biometric Verification Successful</p>
              <p className="text-xs text-green-800 leading-tight">Your face has been verified against the HTU database.</p>
            </div>
          </div>
        </Card>
        ...
        <div className="flex flex-col gap-3">
          <Button
            size="xl"
            className="h-16 w-full text-lg font-bold gap-2"
            onClick={onConfirm}
          >
            Proceed to Ballot
            <ArrowRight size={20} />
